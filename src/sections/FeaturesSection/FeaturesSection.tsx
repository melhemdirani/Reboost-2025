...
export const FeaturesSection = ()  => {
  ...
  return (
    <section className="w-full relative py-10 md:py-20 flex flex-col items-center px-4 md:px-0">
      {/* Testimonials Section */}
      <div className="w-full relative [background:radial-gradient(50%_50%_at_50%_0%,rgba(19,19,21,1)_0%,rgba(0,0,0,1)_100%)] opacity-90 py-10 md:py-20 border-t border-black">
        <div className="w-full h-px [background:radial-gradient(50%_50%_at_50%_50%,rgba(40,40,44,1)_0%,rgba(0,0,0,1)_100%)]" />
        <div id="testimonials" />
        <div className="flex flex-col items-center ]">
          <Badge className="bg-[#131315] text-white font-medium px-6 md:px-9 py-3 rounded-[100px] border border-[rgba(255,255,255,.4)] shadow-[0_0_20px_rgba(255,255,255,0.2)]mb-6 mb-10">
            <img
          ...
          <div className="relative bg-black py-12 px-0 overflow-hidden w-full">
            ...
            <div className="max-w-7xl mx-auto px-4">
              <Slider ref={sliderRef} {...sliderSettings} className="testimonials-slider">
                {testimonials.map((testimonial, index) => (
                    <div key={index} className="bg-[#111111] p-6 px-3 flex flex-col justify-between rounded-xl shadow-lg h-full slide-item">
      ...
      {/* FAQ Section */}
      <div id="faq" className="w-full max-w-[795px] mt-10 md:mt-20 mb-10 md:mb-20 px-4 md:px-0">
        <div className="flex flex-col items-center">
          <Badge className="bg-[#131315] text-white font-medium px-6 md:px-9 py-3 rounded-[100px] border  border-[rgba(255,255,255,.4)] shadow-[0_0_20px_rgba(255,255,255,0.2)]  mb-6">
          ...
          <Accordion type="single" collapsible className="w-full group max-w-[90vw]">
