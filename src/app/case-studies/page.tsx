  ...
  return (
    <div className='min-h-screen bg-black'>
      ...
      <section className='relative py-20 px-4'>
        <div className='max-w-6xl mx-auto text-center'>
          ...
          <p className="text-lg font-medium text-[#cccccc] leading-[27px] [font-family:'Instrument_Sans',Helvetica] max-w-3xl mx-auto mb-16">
            Dive deep into our most successful projects. See how we've helped
            businesses overcome technical challenges, accelerate growth, and
            achieve measurable results through strategic development and
      ...
      {caseStudies.map((study, index) => (
        <section
          key={index}
          className={`py-20 px-4 ${index % 2 === 1 ? 'bg-[#0a0a0a]' : ''}`}
        >
                  ...
                  <div className='flex flex-wrap gap-2'>
                    {study.technologies.map((tech, techIndex) => (
                      <Badge
                        key={techIndex}
                        variant='outline'
                        className='bg-[#1a1a1a] text-[#888] border-[#333] text-xs'
                      >
                        {tech}
                      </Badge>
                    ))}
              ...
              <div className={index % 2 === 1 ? 'lg:col-start-1' : ''}>
                ...
                <div className='grid grid-cols-2 gap-4 mb-8'>
                  {study.results.map((result, resultIndex) => (
                    <Card
                      key={resultIndex}
                      className='bg-[#111111] border border-[#333] rounded-xl'
                    >
